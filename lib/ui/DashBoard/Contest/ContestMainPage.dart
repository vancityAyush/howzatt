...
class _ContestMainPageState extends State<ContestMainPageStateful>
  ...
  void initState() {
    ...
    BlocProvider.of<ContestBloc>(context).add(FetchContestEvent(
        context: context, matchId: widget.matchId.toString()));
    BlocProvider.of<ContestBloc>(context).add(FetchMyContestEvent(
        context: context, matchId: widget.matchId.toString()));
    BlocProvider.of<ContestBloc>(context)
        .add(FetchAllUsersEvent(context: context));
                  ...
                  if (state is CreateContestCompleteState) {
                    WidgetsBinding.instance.addPostFrameCallback((_) {
                      ...
                      Get.to(ContestMainPage(
                          widget.matchId, widget.name, widget.startDate));
                    });
                  }
                },
                child: TabBarView(
                    ...
                    (serverResponse != null &&
                        ...
                        ? ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              sumAmount = 0.0;
                              spotsLeft = 0;
                              List prizeBreakups = serverResponse!["data"]
                                  [index]["prize_breakup"];
                              spotsLeft = int.parse(serverResponse!["data"]
                                          [index]["max_teams"]
                                      .toString()) -
                                  int.parse(serverResponse!["data"][index]
                                          ["teams_joined"]
                                      .toString());
                              var valueRange;
                              if (int.parse(serverResponse!["data"][index]
                                          ["max_teams"]
                                      .toString()) >
                                  int.parse(serverResponse!["data"][index]
                                          ["teams_joined"]
                                      .toString())) {
                                valueRange = (int.parse(serverResponse!["data"]
                                                [index]["teams_joined"]
                                            .toString()) -
                                        int.parse(serverResponse!["data"][index]
                                                ["max_teams"]
                                            .toString())) /
                                    100;
                              } else if (int.parse(serverResponse!["data"]
                                          [index]["teams_joined"]
                                      .toString()) >=
                                  int.parse(serverResponse!["data"][index]
                                          ["max_teams"]
                              ...
                              if (prizeBreakups != null &&
                                  prizeBreakups.length > 0) {
                                var data1 =
                                    prizeBreakups[0].toString().split(":");
                              ...
                              prizeBreakups.forEach((element) {
                                ...
                                var data2 = data1[1].split("}");
                                sumAmount = sumAmount +
                                    double.parse(data2[0].toString());
                              });
                              return GestureDetector(
                                onTap: () {
                                  Get.to(LeaderBoardMainPage(
                                      widget.matchId.toString(),
                                      serverResponse!["data"][index]["amount"]
                                          .toString(),
                                      widget.name.toString(),
                                      widget.startDate.toString(),
                                      serverResponse,
                                      index,
                                      serverResponse!["data"][index]["_id"]
                                          .toString(),
                                      false));
                                },
                                child: Padding(
                                                  ...
                                                  children: [
                                                    Expanded(
                                                      ...
                                                      children: [
                                                        ...
                                                        Image.asset(
                                                          'assets/images/rupee_indian.png',
                                                          width: 12.w,
                                                          height: 12.h,
                                                          color: Colors.black,
                                                        ),
                        ...
                        : DataNotAvailable.dataNotAvailable(
                            "Data not available."),
                    (myServerResponse != null &&
                            myServerResponse!["data"] != null &&
                            myServerResponse!["data"].length > 0)
                        ? ListView.builder(
                            scrollDirection: Axis.vertical,
                            ...
                            itemBuilder: (context, index) {
                              ...
                              sumAmount = 0.0;
                              spotsLeft = 0;
                              List prizeBreakups = myServerResponse!["data"]
                                  [index]["prize_breakup"];
                              spotsLeft = int.parse(myServerResponse!["data"]
                                          [index]["max_teams"]
                                      .toString()) -
                                  int.parse(myServerResponse!["data"][index]
                                          ["teams_joined"]
                                      .toString());
                              var valueRange;
                              if (int.parse(myServerResponse!["data"][index]
                                          ["max_teams"]
                                      .toString()) >
                                  int.parse(myServerResponse!["data"][index]
                                          ["teams_joined"]
                                      .toString())) {
                                valueRange = (int.parse(
                                            myServerResponse!["data"][index]
                                                    ["teams_joined"]
                                                .toString()) -
                                        int.parse(myServerResponse!["data"]
                                                [index]["max_teams"]
                                            .toString())) /
                                    100;
                              } else if (int.parse(myServerResponse!["data"]
                                          [index]["teams_joined"]
                                      .toString()) >=
                                  int.parse(myServerResponse!["data"][index]
                                          ["max_teams"]
                              ...
                              if (prizeBreakups != null &&
                                ...
                                if (data2.length > 0 && data2[0] != "''") {
                                  var amoutnArray =
                                      data2[0].toString().split("'");
                                  firstAmount =
                                      double.parse(amoutnArray[1].toString());
                                }
                              }
                              prizeBreakups.forEach((element) {
                                var data1 = element.toString().split(":");
                              ...
                              return GestureDetector(
                                onTap: () {
                                  Get.to(LeaderBoardMainPage(
                                      widget.matchId.toString(),
                                      myServerResponse!["data"][index]["amount"]
                                          .toString(),
                                      widget.name.toString(),
                                      widget.startDate.toString(),
                                      myServerResponse,
                                      index,
                                      myServerResponse!["data"][index]["_id"]
                                          .toString(),
                                      true));
                                },
                                child: Padding(
                  ...
                  onPressed: () {
                    if (isTimeOver == false) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                        content: Text(
                          "You're not able to create Contest.",
                          style: TextStyle(
                              color: Colors.white,
                              fontSize: 15.sp,
                              fontWeight: FontWeight.bold),
  ...
  inviteFriends(BuildContext context, List<UserData>? usersList,
      String? contest_id, String? matchId, String? name, String? startDate) {
    return showMaterialModalBottomSheet(
        context: context,
        elevation: 0,
        backgroundColor: Colors.transparent,
                    ...
                    builder: (BuildContext context, StateSetter mystate) {
                      return Column(
                        children: [
                          ...
                          Expanded(
                              child: (serachUsersList != null &&
                                      serachUsersList.length > 0)
                                  ? ListView.builder(
...
class UserListDialog extends StatefulWidget {
  ...
  UserListDialog(List<UserData>? _usersList, String? _contest_id,
      String? _matchId, String? _name, String? _startDate) {
