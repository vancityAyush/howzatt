...
class HomePageProvider {
  ...
  Future<Response?> getScheduleMatchDataEvent(BuildContext context,String accessToken) async {
  ...
  Future<String?> updateToken(BuildContext context) async {
    ...
    try {
      ...
      var request = await http.put(Uri.parse(apiUrl),body: data,headers: headers);
